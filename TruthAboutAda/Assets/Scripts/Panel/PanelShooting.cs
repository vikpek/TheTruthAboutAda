...
public class PanelShooting : MonoBehaviour 
{
	...
	int scanKeys() 
	{
		...
		if( Input.GetKeyDown( KeyCode.KeypadEnter ) || Input.GetKeyDown( KeyCode.UpArrow ) || Input.GetKeyDown( KeyCode.JoystickButton0 ) || Input.GetKeyDown( KeyCode.Space ) ) return 10;
