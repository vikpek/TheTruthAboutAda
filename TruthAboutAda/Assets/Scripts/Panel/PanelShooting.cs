	...
	int scanKeys() 
	{
		switch( multi )
		{
			...
			case 1 :
				...
				if( Input.GetKeyDown( KeyCode.Space ) || Input.GetKeyDown( KeyCode.Return ) ) return 10;
			...
			case 2 :
				...
				if( Input.GetKeyDown( KeyCode.KeypadEnter ) || Input.GetMouseButtonDown( 0 ) ) return 10;
				if( Input.GetAxisRaw("Mouse ScrollWheel") < 0 ) return 11;
				if( Input.GetAxisRaw("Mouse ScrollWheel") > 0 ) return 12;
				break;
		}
		return -1;
	}
